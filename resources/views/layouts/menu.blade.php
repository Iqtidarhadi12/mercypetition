...
<!-- <font style=" font:bold 30px 'Aleo'; color:#722290;"><center><span ><img src="{{asset('adminassets\assets\image\C.jpg')}}" width="80" height="90" /> <font color ="blue">Inspectorate General</font></span><span><font color ="#800000"> of Prisons Khyber Pakhtunkhwa  <img  src="{{asset('adminassets\assets\image\D.jpg')}}" width="65" height="75" /> </span></font></center></font> -->
            <!--       <div class="dropdown-menu dropdown-menu-right dropdown-animated brc-primary-m3 radius-2 py-2 py-md-0 dd-slide-up dd-slide-none-md">
              ...
              <button class="navbar-toggler ml-1 mr-2 px-1" type="button" data-toggle="collapse" data-target="#navbarMenu" aria-controls="navbarMenu" aria-expanded="false" aria-label="Toggle navbar menu">
                ...
                <img class="mx-0 radius-round border-2 brc-primary-tp3 p-1px" src="{{asset('adminassets\assets\image\C.jpg')}}" width="36" alt="Natalie's Photo">
              </button>
